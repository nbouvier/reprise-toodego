...
CREATE TABLE "instruction_rsj"
    (
        ...
        "city"                            character varying NOT NULL,
        "postalCode"                      character varying NOT NULL,
        "beginDateAddress"                date NOT NULL             ,
        "sixMonthsResident"               boolean NOT NULL          ,
        "outOfEducationSystem"            boolean NOT NULL          ,
        "noSupportCause"                  character varying         ,
        "familyQuotient"                  integer                   ,
        "otherIncomePrecision"            character varying         ,
        "withoutSolidarityPlan"           boolean NOT NULL          ,
        "withoutYouthPlan"                boolean NOT NULL          ,
        "socialCareInProgress"            boolean                   ,
        "socialStructureName"             character varying         ,
        "aseService"                      boolean                   ,
        "aseServiceLyon"                  boolean                   ,
        "youngAdultContract"              boolean                   ,
        "rsaSimulation"                   boolean                   ,
        "maritalStatus"                   character varying         ,
        "parentsOrPartnerOnRsa"           boolean                   ,
        "dependentsNumber"                integer                   ,
        ...
        "highestDegree"                   character varying         ,
        "drivingLicense"                  boolean NOT NULL          ,
        "peRegistration"                  boolean NOT NULL          ,
        "rqth"                            boolean NOT NULL          ,
        "localMission"                    boolean                   ,
...
CREATE TABLE "instruction_rsj_transport_mode"
    (
        "instructionRsjId" integer NOT NULL,
        "transportModeId"  integer NOT NULL,
        CONSTRAINT "PK_INSTRUCTION_RSJ_ID_TRANSPORT_MODE_ID" PRIMARY KEY ("instructionRsjId", "transportModeId")
    )
;
...
CREATE INDEX "IDX_INSTRUCTION_RSJ_TRANSPORT_MODE_INS" ON "instruction_rsj_transport_mode" ("instructionRsjId");
CREATE INDEX "IDX_INSTRUCTION_RSJ_TRANSPORT_MODE_TRA_MOD" ON "instruction_rsj_transport_mode" ("transportModeId");
...
ALTER TABLE "instruction_rsj" ADD CONSTRAINT "FK_INSTRUCTION_RSJ_QPV" FOREIGN KEY ("qPVId") REFERENCES "qpv"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;
ALTER TABLE "instruction_rsj" ADD CONSTRAINT "FK_INSTRUCTION_RSJ_DEGREE" FOREIGN KEY ("degreeId") REFERENCES "degree"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;
...
ALTER TABLE "instruction_rsj_transport_mode" ADD CONSTRAINT "FK_INSTRUCTION_RSJ_TRANSPORT_MODE_INS" FOREIGN KEY ("instructionRsjId") REFERENCES "instruction_rsj"("id") ON DELETE CASCADE ON UPDATE NO ACTION;
ALTER TABLE "instruction_rsj_transport_mode" ADD CONSTRAINT "FK_INSTRUCTION_RSJ_TRANSPORT_MODE_TRA_MOD" FOREIGN KEY ("transportModeId") REFERENCES "transport_mode"("id") ON DELETE CASCADE ON UPDATE NO ACTION;
...
(SELECT
	...
	instruction_rsj."residentialStatus",
	instruction_rsj."hostedFreeOfCharge",
	instruction_rsj."ccasDomiciliation",
